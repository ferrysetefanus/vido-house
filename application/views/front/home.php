    ...
    <section class="section-padding">
      ...
      <section id="menu-list" class="section-padding">
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center marb-35">
             <h1 class="header-h">Daftar Menu</h1>
             <p class="header-p">Silakan Memilih dan Menikmati
              <br> Makanan Sensasi Rasa dan Kenikmatan Khas Italy </p>
            </div>

            <div class="col-md-12  text-center" id="menu-flters">
              <ul>
                <li><a class="filter active" data-filter=".menu-restaurant">Semua Menu</a></li>
                <li><a class="filter" data-filter=".breakfast">Menu Makanan</a></li>
                <li><a class="filter" data-filter=".lunch">Menu Minuman</a></li>
                <li><a class="filter" data-filter=".dinner">Dessert</a></li>
              </ul>
            </div>
            ...
            <div id="menu-wrapper">
              ...
              <div class="lunch menu-restaurant">
                <span class="clearfix">
                  <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg">Dinks Menu</a>
                  <span style="left: 166px; right: 44px;" class="menu-line"></span>
                  <span class="menu-price">$20.99</span>
                </span>
                <span class="menu-subtitle">Neque porro quisquam est qui dolorem</span>
              ...
              <div class="dinner menu-restaurant">
                <span class="clearfix">
                  <a class="menu-title" href="#" data-meal-img="assets/img/restaurant/rib.jpg">Dessert</a>
                  <span style="left: 166px; right: 44px;" class="menu-line"></span>
                  <span class="menu-price">$20.99</span>
                </span>
                <span class="menu-subtitle">Neque porro quisquam est qui dolorem</span>
              ...
              <div class="col-md-4 col-sm-4 mr-15">
                <div class="media-2">
                  ...
                  <div class="media-body">
                    <h4 class="dark-blue regular">Nomor Telepon</h4>
                    <p class="light-blue regular alt-p">0812-8208-8706 - <span class="contacts-sp">Phone Booking</span></p>
                    <!--Nomor Telepon bagian Ryan Septian-->
                  </div>
                </div>
                <div class="media-2">
                  <div class="media-left">
                  ...
                  <div class="media-body">
                    <h4 class="dark-blue regular">Jam Operasional</h4>
                    <p class="light-blue regular alt-p"> Monday to Friday 09.30 - 22:00</p>
                    <p class="light-blue regular alt-p">
                      <!--Jam Operasional Bagian Ryan Septian-->
                    </p>
                  </div>
                </div>
              </div>
